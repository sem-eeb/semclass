...
__Overview:__  We'll pick up where we left off discussing covariance-based estimation. We'll spend time discussing how we evaluate an SEM and what we report. We'll end the day (if we have time) exploring the concept of latent variables - variables for which we do not actually have a measured variable, but for which we have one or more indicators.  
