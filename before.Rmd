...
Hello everyone! We're looking forward to our upcoming journey into the wild world of Structural Equation Modeling together. Before the class begins, I want to make sure you all are prepared so that you can get the most out of it and to have you work through this preclass-excercise and tutorial.
  
The course is going to be a mixture of lecture and hands-on exercises. Aside from model building and identification exercises, everything else will be in R. We will assume that you have at least basic proficiency in R. You will need basic proficiency in order to work through the the class. What does basic proficiency mean? We expect that
  
0. You have the latest version of [R 4.0.3](https://cran.r-project.org/) installed on your computer  and be able to access help files. It is also helpful to have the latest version of [R Studio](https://rstudio.com/products/rstudio/download/#download) installed so you are able to follow along with the instructors 
...
I would then ask that you [run this script](./files/scripts/Install_Required_Packages.R) to install the packages for the course. If you have any questions, [contact us](mailto:jarrett.byrnes@umb.edu).
...
- Work through the lab handouts for weeks 1, 3, 5, and 6 of [Jarrett's own intro biostats course](https://biol607.github.io/schedule.html). It's what I teach, and those weeks provide you with the background you need for this course - and beyond. Feel free to try out other lessons to build your chops.
